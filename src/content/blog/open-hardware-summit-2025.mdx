...
From the Ancient Egyptians to late-20th-Century punch card knitting machines, Carson Holgate takes us through the history of knitting machines. [She highlights the efforts to breathe new life into hardware which would otherwise be left of the shelf](https://www.ayab-knitting.com/).
...
In this talk, Kliment discusses the challenges in maintaining the [KiCad project](https://gitlab.com/kicad/code/kicad) and progress that has been made to address these issues. Challenges addressed include the never-ending nature of incoming pull requests and lack of code reviewers.
